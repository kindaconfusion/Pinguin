...
{
    public static async IAsyncEnumerable<PingObject> RunTraceroute(PingObject host)
    {
        ...
        if (options.Ttl == 30) throw new TimeoutException("Unable to reach host after 30 hops.");
    }
}